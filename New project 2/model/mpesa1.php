...
class mpesa1{
     ...
     private $consumerKey = '2L5KKBRT62iOiFAXfpbXsqR9TytA00w8';
     //set your consumer sectet here
     private $consumerSecret = 'GzCe4LUsGJLT2GvG';
///Used to generate a password used to interact with any Safaricom Mpesa API

    //set here your callback url, 
    private $callbackUrl ='http://localhost/web-new_branch/mmpesa/callback/';
