...
mysqli_close($conn);
    ...
    <form action="driveredit.php" method="Post" enctype="multipart/form-data">
        <table>
          ...
          <tr>
            <td>Surname</td><td>
			<input type="text" value="<?php echo $record[2]; ?>" name="surname" required></td>
          </tr>

          <tr>
            <td>First Name</td>
			<td><input type="text" value="<?php echo $record[3]; ?>" name="firstname" required></td>
          </tr>
			
          <tr>
            <td>Second Name</td>
			<td><input type="int" value="<?php echo $record[4]; ?>" name="secondname" required></td>
          </tr>
		  
		  <tr>
            <td>Phone Number</td>
			<td><input type="int" value="<?php echo $record[4]; ?>" name="phonenumber" required></td>
          </tr>
		  ...
		  <tr>
            <td>Shift Time</td>
			<td><input type="time" value="<?php echo $record[4]; ?>" name="shift_time" required></td>
          </tr>
		  
		  <tr>
            <td>Date of Joining</td>
			<td><input type="date" value="<?php echo $record[4]; ?>" name="date_of_joining" required></td>
          </tr>
